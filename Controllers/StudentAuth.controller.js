...
const registerStudent = async (req, res) => {
    try {
        ...
        if (!email || !enrollmentNumber || !password) {
            return ResponseHandler.error(res, "Email, enrollment number, and password are required", 400);
        }
        ...
        if (existingEnrollment) {
            return ResponseHandler.error(res, "Enrollment number already registered", 400);
        }
